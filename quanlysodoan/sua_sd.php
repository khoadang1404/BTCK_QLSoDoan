                        ...
                        <div class="position-center">
                            <form role="form" action="index.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name ="nop" value="<?php echo date('Y-m-d',strtotime($sd['tgnop'])); ?>" class="form-control" placeholder="Ngày nộp">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Ngày rút</label>
                                    <input type="date" name ="rut" value="<?php echo date('Y-m-d',strtotime($sd['tgrut'])); ?>" class="form-control" placeholder="Ngày rút">
                                </div>
